# How to Translate Icon Previewer

## First Things First

* Clone this repository by opening the terminal in a folder of your choice and typing ```git clone https://github.com/lainsce/icon-previewer```
...
And that's it! You've successfully translated Icon Previewer for your language!
